...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.uploadLimitReachedLabel = QtWidgets.QLabel(self.centralWidget)
        self.uploadLimitReachedLabel.setStyleSheet("color: red;")
        self.uploadLimitReachedLabel.setAlignment(QtCore.Qt.AlignCenter)
        self.uploadLimitReachedLabel.setObjectName("uploadLimitReachedLabel")
        self.verticalLayout_2.addWidget(self.uploadLimitReachedLabel)
        ...
        self.fileList.setGeometry(QtCore.QRect(0, 0, 625, 166))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.uploadLimitReachedLabel.setText(_translate("MainWindow", "Has alcanzado el límite de subidas diarias."))
